...
class AppConstants {
  static const String APP_NAME = 'Driver Track';

  //static const String BASE_URL = 'https://admin.salvafastfood.com';

  static const String BASE_URL = 'https://s3bits.com/kk-food';
 // static const String BASE_URL = 'https://s3bits.com/rooftech';  //https://s3bits.com/delivery-admin
