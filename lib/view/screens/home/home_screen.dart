        ...
        child: SingleChildScrollView(
          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            ...
            return Column(children: [
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Row(children: [
                      ...
                      // EarningWidget(
                      //   title: ''.tr,
                      //   amount: authController.profileModel != null ? "" : null,
                      // ),
                    ]),
                  ]),
                ),
              ...
              TitleWidget(title: ''.tr),
              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
              Row(children: [
                Expanded(child: CountCard(
                  title: ''.tr, backgroundColor:Colors.black, height: 180,
                  value: authController.profileModel != null ? "".toString() : null,
                )),
                SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                Expanded(child: CountCard(
                  title: ''.tr, backgroundColor:Colors.black, height: 180,
              ...
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
              CountCard(
                title: 'Save Your Current Location', backgroundColor: Colors.green, height: 140,
